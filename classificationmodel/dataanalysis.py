...
class SpendDataAnalyzer:
    ...
    def analyze_categorization_data(self):
        ...
        l5_counts = self.training_data['Cateogry L5'].value_counts().head(20)
    ...
    def create_visualizations(self):
        ...
        # 3. Top Category L5
        if 'Cateogry L5' in self.training_data.columns:
            l5_data = self.training_data['Cateogry L5'].value_counts().head(10)
    ...
    def generate_data_quality_report(self):
        ...
        if self.training_data is not None:
            ...
            if 'Cateogry L5' in self.training_data.columns:
                missing_l5 = self.training_data['Cateogry L5'].isnull().sum()
