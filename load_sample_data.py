...
def load_sample_data():
    ...
    try:
        ...
        print("Loading sample spend data...")
        df = pd.read_excel(sample_file)
        print(f"Loaded {len(df)} rows from sample data file")
        ...
        print(f"Successfully inserted {len(df_final)} transactions into database")
        ...
        if 'supplier_name' in df_final.columns:
            ...
            print(f"Successfully inserted {len(unique_vendors)} vendors into database")
        ...
        print(f"Successfully inserted {len(categories_to_add)} categories into database")
        
        # Generate some sample errors for demonstration
        print("Generating sample error logs...")
        ...
        print(f"Successfully generated {len(sample_errors)} sample error logs")
